...
import { LoginAdminInterface } from "../../interfaces/lLogin_admin";
...
function LoginAdmin() {
  const [signin, setSignin] = useState<Partial<LoginAdminInterface>>({});
  const [signinAdmin, setSigninAdmin] = useState<Partial<LoginAdminInterface>>(
    {}
  );
  ...
  async function LoginAdmin(data: LoginAdminInterface) {
      ...
      <Grid container component="main" sx={{ height: "100vh" }}>
        ...
        <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
          ...
          >
            ...
            <Typography component="h1" variant="h5" sx={{color: "#A0A0A0" }}>
              for Admin 
            </Typography>
            <Box sx={{ mt: 1 }}>
              <TextField
