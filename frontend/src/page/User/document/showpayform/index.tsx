...
import { DeleteDocumentID, GetPayFormByUserID} from "../../../../sevices/http/indexdocument";
...
function ShowPayForm() {
   ...
   const [payFormID, setPayFormID] = useState(0);
      ...
      const fetchPayForm = async () => {
       
         const data = await GetPayFormByUserID(Number(userID));
            setDocument(data);
      };
   ...
   return (
      <idPayForm.Provider value={payFormID}>
            ...
            <Table>
               ...
               <TableBody>
                  ...
                  <TableRow key={index}>
                     ...
                     <TableCell>{data.RoomBill}</TableCell>
                     <TableCell>{data.WaterBill}</TableCell>
                     <TableCell>{data.ElectricBill}</TableCell>
                     ...
                     {data.DocumentStatus?.DocumentStatusName === "รอการอนุมัติ" &&
                        ...
                        if(data.ID !== undefined){
                           console.log(data.ID);
                           navigate("/editpayform",{state: data.ID});
                        }}}>
